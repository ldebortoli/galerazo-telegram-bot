...
- El host `galerazo-prod` esta preparado con Docker Engine/Compose y Google Cloud CLI; Docker esta habilitado y los directorios de datos, backups y secretos tienen los owners/modos esperados. `bot.env` real esta configurado como root 0600 sin OpenAI/Google Sheets y SQLite real esta instalado como 10001:10001/0600 con integridad verificada. Tras el primer fallo, el contenedor `d8ae2ecc00f5` quedó detenido y la imagen corregida `db278a097b62` fue descargada/probada sin iniciar Telegram; el primer deploy saludable sigue pendiente.
