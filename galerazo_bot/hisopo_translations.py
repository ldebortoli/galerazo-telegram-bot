...
HISOPO_COLLECTION_TRANSLATIONS: dict[str, dict[str, str]] = {
    "es": {
        ...
        "hisopos.collection.mystery_note": "El Misterioso cuenta como el tipo real que revela.",
    },
    "en": {
        ...
        "hisopos.collection.mystery_note": "A Mystery counts as the real type it reveals.",
    },
    "es_ES": {
        "help.coleccionhisopos": "muestra tu colección histórica de Hisopos",
        "hisopos.collection.header": "Colección histórica de {user} ({user_id})",
    ...
    "ca": {
        ...
        "hisopos.collection.mystery_note": "El Misteriós compta com el tipus real que revela.",
    },
    "de": {
        ...
        "hisopos.collection.mystery_note": "Das Mysteriöse zählt als die echte Art, die es enthüllt.",
    },
    "eu": {
        ...
        "hisopos.collection.mystery_note": "Misteriotsuak agerian uzten duen benetako mota gisa zenbatzen du.",
    },
    "fr": {
        ...
        "hisopos.collection.mystery_note": "Le Mystérieux compte comme le type réel qu'il révèle.",
    },
    "gn": {
        ...
        "hisopos.collection.mystery_note": "Ñemi ojepapa ohechaukáva hisopo añeteguáicha.",
    },
    "it": {
        ...
        "hisopos.collection.mystery_note": "Il Misterioso conta come il tipo reale che rivela.",
    },
    "ja": {
        ...
        "hisopos.collection.mystery_note": "ミステリーは、明らかになった本当の種類として数えられます。",
    },
    "la": {
        ...
        "hisopos.collection.mystery_note": "Mysteriosum pro vero genere quod revelat numeratur.",
    },
    "nl": {
        ...
        "hisopos.collection.mystery_note": "Het Mysterie telt als het echte type dat wordt onthuld.",
    },
    "pt_BR": {
        ...
        "hisopos.collection.mystery_note": "O Misterioso conta como o tipo real que revela.",
    },
    "pt_PT": {
    ...
    "quz": {
        ...
        "hisopos.collection.mystery_note": "Paka hisopoqa sut'inchasqan chiqap laya hina yupakun.",
    },
    "ru": {
        ...
        "hisopos.collection.mystery_note": "Таинственная считается тем настоящим видом, который она раскрывает.",
    },
    "zh_Hans": {
        ...
        "hisopos.collection.mystery_note": "神秘棉签按揭晓后的真实种类计入。",
    },
    "zh_Hant": {
        ...
        "hisopos.collection.mystery_note": "神祕棉花棒按揭曉後的真實種類計入。",
    },
}

HISOPO_COLLECTION_RULES: dict[str, str] = {
    "es": "- Colección histórica: /coleccionhisopos muestra tus 11 tipos reales y sus cantidades. El Misterioso cuenta como lo que revela; el Fugaz oculto vencido no cuenta y cada participante de un Gigante completado lo colecciona.",
    "en": "- Historical collection: /coleccionhisopos shows your 11 real types and their counts. A Mystery counts as what it reveals; an expired hidden Fleeting does not count, and every participant collects a completed Giant.",
    "es_ES": "- Colección histórica: /coleccionhisopos muestra tus 11 tipos reales y sus cantidades. El Misterioso cuenta como lo que revela; el Fugaz oculto caducado no cuenta y cada participante de un Gigante completado lo colecciona.",
    "ca": "- Col·lecció històrica: /coleccionhisopos mostra els teus 11 tipus reals i les quantitats. El Misteriós compta com el que revela; el Fugaç ocult caducat no compta i cada participant col·lecciona un Gegant completat.",
    "de": "- Historische Sammlung: /coleccionhisopos zeigt deine 11 echten Arten und ihre Anzahl. Ein Mysteriöses zählt als enthüllte Art; ein abgelaufenes verborgenes Flüchtiges zählt nicht, und alle Beteiligten sammeln einen vollendeten Riesen.",
    "eu": "- Bilduma historikoa: /coleccionhisopos komandoak zure 11 benetako motak eta kopuruak erakusten ditu. Misteriotsua agertzen duen bezala zenbatzen da; iraungitako Ezkutu Iheskorra ez da zenbatzen, eta amaitutako Erraldoiaren parte-hartzaile guztiek bilduman jasotzen dute.",
    "fr": "- Collection historique : /coleccionhisopos affiche vos 11 types réels et leurs quantités. Le Mystérieux compte comme ce qu'il révèle ; un Fugitif caché expiré ne compte pas et chaque participant collectionne un Géant terminé.",
    "gn": "- Ñembyaty rembiasakue: /coleccionhisopos ohechauka 11 hisopo añetegua ha mboypa reguereko. Ñemi ojepapa ohechaukávaicha; Pya'e kañymby oñembyaimava ndojepapái ha Tuichaitéva oñemohu'ãramo mayma oipytyvõva ombyaty.",
    "it": "- Collezione storica: /coleccionhisopos mostra i tuoi 11 tipi reali e le quantità. Il Misterioso conta come ciò che rivela; un Fugace nascosto scaduto non conta e ogni partecipante colleziona un Gigante completato.",
    "ja": "- 歴代コレクション：/coleccionhisopos は11種類の実物と所持数を表示します。ミステリーは判明した種類として数え、期限切れの隠れた一瞬は数えません。巨大を完成させると参加者全員のコレクションに加わります。",
    "la": "- Collectio historica: /coleccionhisopos undecim genera vera tua eorumque numeros ostendit. Mysteriosum pro eo quod revelat numeratur; Fugitivum occultum expletum non numeratur, et omnes participes Gigantem perfectum colligunt.",
    "nl": "- Historische collectie: /coleccionhisopos toont je 11 echte typen en aantallen. Een Mysterie telt als wat het onthult; een verlopen verborgen Vluchtige telt niet, en iedere deelnemer verzamelt een voltooide Reus.",
    "pt_BR": "- Coleção histórica: /coleccionhisopos mostra seus 11 tipos reais e as quantidades. O Misterioso conta como o que revela; um Fugaz oculto vencido não conta e cada participante coleciona um Gigante concluído.",
    "pt_PT": "- Coleção histórica: /coleccionhisopos mostra os teus 11 tipos reais e as quantidades. O Misterioso conta como o que revela; um Fugaz oculto expirado não conta e cada participante coleciona um Gigante concluído.",
    "quz": "- Ñawpa huñuy: /coleccionhisopos 11 chiqap layaykikunata, hayk'a kasqantawan rikuchin. Paka hisopo sut'inchasqanhina yupakun; pacha tukusqa paka Utqaq mana yupakunchu, Hatun hisopota tukuchiq llapan yanapaqkunataq huñunku.",
    "ru": "- Коллекция за всё время: /coleccionhisopos показывает ваши 11 настоящих видов и их количество. Таинственная считается раскрытым видом; просроченная скрытая Мимолётная не учитывается, а завершённая Гигантская попадает в коллекцию каждого участника.",
    "zh_Hans": "- 历史收藏：/coleccionhisopos 显示你的11种真实类型及数量。神秘棉签按揭晓的类型计入；已过期的隐藏迅捷棉签不计入，完成巨型棉签时每位参与者都会收藏它。",
    "zh_Hant": "- 歷史收藏：/coleccionhisopos 顯示你的11種真實類型及數量。神祕棉花棒按揭曉的類型計入；已過期的隱藏迅捷棉花棒不計入，完成巨型棉花棒時每位參與者都會收藏它。",
}
