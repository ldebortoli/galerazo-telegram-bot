...
Archivo: `hisopo-usado.png`

Prompt final, generado con ImageGen integrado sin imágenes de referencia:

> Use case: stylized-concept. Asset type: square collectible artwork for a Telegram bot game. Primary request: create an original "Hisopo usado" (used cotton swab) matching a polished whimsical 3D collectible-card asset. Show exactly one full double-ended cotton swab, diagonally oriented from lower left to upper right, with a slightly worn pale-blue plastic stem. Both cotton tips are visibly used and coated with unpleasant amber-to-brown earwax: sticky waxy smears, small glossy clumps, matted cotton fibers, asymmetric dirt, disgusting but playful and non-gory. Scene/backdrop: clean pale icy-blue and warm-white studio gradient with a soft ground shadow and a few subtle ironic sparkles, visually related to a premium game collectible. Composition/framing: square, centered, entire swab visible with generous margins on all sides, no cropping, strong readable silhouette suitable for Telegram's media crop. Lighting/mood: bright soft studio lighting; high-detail tactile cotton and wax; humorous contrast between polished presentation and gross used tips. Constraints: exactly one swab; both ends must have cotton tips and both tips must visibly contain earwax; no people, hands, ears, packaging, text, letters, numbers, logos, watermark, gore, insects, green rot, smoke, or extra objects.
