...
No hay una implementacion activa. Los `NetworkError` transitorios del polling ya no se anuncian falsamente como errores no handleados; la correccion esta validada y desplegada.
