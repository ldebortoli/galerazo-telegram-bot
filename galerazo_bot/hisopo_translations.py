...
HISOPO_COLLECTION_TRANSLATIONS: dict[str, dict[str, str]] = {
    "es": {
        "hisopos.collection.chat": "Coleccionables de este chat",
        "hisopos.collection.cosmetics": "Cosméticos — todos los chats",
        "help.coleccionhisopos": "muestra tu colección de Hisopos y cosméticos",
    ...
    "en": {
        "hisopos.collection.chat": "Collectibles in this chat",
        "hisopos.collection.cosmetics": "Cosmetics — all chats",
        "help.coleccionhisopos": "shows your Swab collection and cosmetics",
    ...
    "ca": {
        "hisopos.collection.chat": "Col·leccionables d’aquest xat",
        "hisopos.collection.cosmetics": "Cosmètics — tots els xats",
    ...
    "de": {
        "hisopos.collection.chat": "Sammlerstücke in diesem Chat",
        "hisopos.collection.cosmetics": "Kosmetische Artikel — alle Chats",
    ...
    "eu": {
        "hisopos.collection.chat": "Txat honetako bildumakoak",
        "hisopos.collection.cosmetics": "Kosmetikoak — txat guztietan",
    ...
    "fr": {
        "hisopos.collection.chat": "Objets de collection de ce chat",
        "hisopos.collection.cosmetics": "Cosmétiques — tous les chats",
    ...
    "gn": {
        "hisopos.collection.chat": "Ko ñomongetápe oñembyatýva",
        "hisopos.collection.cosmetics": "Jegua rehegua — opa ñomongetápe",
    ...
    "it": {
        "hisopos.collection.chat": "Collezionabili di questa chat",
        "hisopos.collection.cosmetics": "Cosmetici — tutte le chat",
    ...
    "ja": {
        "hisopos.collection.chat": "このチャットのコレクション",
        "hisopos.collection.cosmetics": "コスメ — 全チャット共通",
    ...
    "la": {
        "hisopos.collection.chat": "Collectanea huius colloquii",
        "hisopos.collection.cosmetics": "Ornamenta — omnia colloquia",
    ...
    "nl": {
        "hisopos.collection.chat": "Verzamelobjecten in deze chat",
        "hisopos.collection.cosmetics": "Cosmetische items — alle chats",
    ...
    "pt_BR": {
        "hisopos.collection.chat": "Colecionáveis deste chat",
        "hisopos.collection.cosmetics": "Cosméticos — todos os chats",
    ...
    "quz": {
        "hisopos.collection.chat": "Kay rimanakuypi huñusqakuna",
        "hisopos.collection.cosmetics": "Sumaqchana — llapan rimanakuykunapi",
    ...
    "ru": {
        "hisopos.collection.chat": "Коллекционные предметы этого чата",
        "hisopos.collection.cosmetics": "Косметические предметы — все чаты",
    ...
    "zh_Hans": {
        "hisopos.collection.chat": "本聊天的收藏品",
        "hisopos.collection.cosmetics": "外观收藏品 — 所有聊天通用",
    ...
    "zh_Hant": {
        "hisopos.collection.chat": "本聊天的收藏品",
        "hisopos.collection.cosmetics": "外觀收藏品 — 所有聊天通用",
...
HISOPO_RACE_TRANSLATIONS: dict[str, dict[str, str]] = {
    "es": {
        ...
        "hisopos.expired_caption_collected": "Era un {type_label}, pero se te venció, así que lo perdiste.",
        "hisopos.expired_caption_mystery": "Era un {type_label}, pero se te venció, así que lo perdiste.",
        "hisopos.expired_popup_collected": "Era un {type_label}, pero se te venció, así que lo perdiste.",
        "hisopos.expired_popup_mystery": "Era un {type_label}, pero se te venció, así que lo perdiste.",
    },
    "en": {
        ...
        "hisopos.expired_caption_collected": "It was a {type_label}, but it expired, so you missed it.",
        "hisopos.expired_caption_mystery": "It was a {type_label}, but it expired, so you missed it.",
        "hisopos.expired_popup_collected": "It was a {type_label}, but it expired, so you missed it.",
        "hisopos.expired_popup_mystery": "It was a {type_label}, but it expired, so you missed it.",
    },
    "es_ES": {
        "hisopos.type.frenetic": "hisopo frenético",
        "hisopos.type.black_hole": "hisopo agujero negro",
        ...
        "hisopos.expired_caption_collected": "Era un {type_label}, pero se te ha caducado, así que lo has perdido.",
        "hisopos.expired_caption_mystery": "Era un {type_label}, pero se te ha caducado, así que lo has perdido.",
        "hisopos.expired_popup_collected": "Era un {type_label}, pero se te ha caducado, así que lo has perdido.",
        "hisopos.expired_popup_mystery": "Era un {type_label}, pero se te ha caducado, así que lo has perdido.",
    },
    "ca": {
        ...
        "hisopos.expired_caption_collected": "Era un {type_label}, però se t'ha caducat, així que l'has perdut.",
        "hisopos.expired_caption_mystery": "Era un {type_label}, però se t'ha caducat, així que l'has perdut.",
        "hisopos.expired_popup_collected": "Era un {type_label}, però se t'ha caducat, així que l'has perdut.",
        "hisopos.expired_popup_mystery": "Era un {type_label}, però se t'ha caducat, així que l'has perdut.",
    },
    "de": {
        ...
        "hisopos.expired_caption_collected": "Es war ein {type_label}, aber es ist abgelaufen, also hast du es verpasst.",
        "hisopos.expired_caption_mystery": "Es war ein {type_label}, aber es ist abgelaufen, also hast du es verpasst.",
        "hisopos.expired_popup_collected": "Es war ein {type_label}, aber es ist abgelaufen, also hast du es verpasst.",
        "hisopos.expired_popup_mystery": "Es war ein {type_label}, aber es ist abgelaufen, also hast du es verpasst.",
    },
    "eu": {
        ...
        "hisopos.expired_caption_collected": "{type_label} bat zen, baina iraungi egin zen; beraz, galdu duzu.",
        "hisopos.expired_caption_mystery": "{type_label} bat zen, baina iraungi egin zen; beraz, galdu duzu.",
        "hisopos.expired_popup_collected": "{type_label} bat zen, baina iraungi egin zen; beraz, galdu duzu.",
        "hisopos.expired_popup_mystery": "{type_label} bat zen, baina iraungi egin zen; beraz, galdu duzu.",
    },
    "fr": {
        ...
        "hisopos.expired_caption_collected": "C'était un {type_label}, mais il a expiré, donc tu l'as perdu.",
        "hisopos.expired_caption_mystery": "C'était un {type_label}, mais il a expiré, donc tu l'as perdu.",
        "hisopos.expired_popup_collected": "C'était un {type_label}, mais il a expiré, donc tu l'as perdu.",
        "hisopos.expired_popup_mystery": "C'était un {type_label}, mais il a expiré, donc tu l'as perdu.",
    },
    "gn": {
        ...
        "hisopos.expired_caption_collected": "Ha'e kuri {type_label}, hákatu hi'ára opáma, upévare reperde.",
        "hisopos.expired_caption_mystery": "Ha'e kuri {type_label}, hákatu hi'ára opáma, upévare reperde.",
        "hisopos.expired_popup_collected": "Ha'e kuri {type_label}, hákatu hi'ára opáma, upévare reperde.",
        "hisopos.expired_popup_mystery": "Ha'e kuri {type_label}, hákatu hi'ára opáma, upévare reperde.",
    },
    "it": {
        ...
        "hisopos.expired_caption_collected": "Era un {type_label}, ma è scaduto, quindi l'hai perso.",
        "hisopos.expired_caption_mystery": "Era un {type_label}, ma è scaduto, quindi l'hai perso.",
        "hisopos.expired_popup_collected": "Era un {type_label}, ma è scaduto, quindi l'hai perso.",
        "hisopos.expired_popup_mystery": "Era un {type_label}, ma è scaduto, quindi l'hai perso.",
    },
    "ja": {
        ...
        "hisopos.expired_caption_collected": "{type_label}でしたが、期限切れになったので逃しました。",
        "hisopos.expired_caption_mystery": "{type_label}でしたが、期限切れになったので逃しました。",
        "hisopos.expired_popup_collected": "{type_label}でしたが、期限切れになったので逃しました。",
        "hisopos.expired_popup_mystery": "{type_label}でしたが、期限切れになったので逃しました。",
    },
    "la": {
        ...
        "hisopos.expired_caption_collected": "{type_label} erat, sed expletum est; itaque amisisti.",
        "hisopos.expired_caption_mystery": "{type_label} erat, sed expletum est; itaque amisisti.",
        "hisopos.expired_popup_collected": "{type_label} erat, sed expletum est; itaque amisisti.",
        "hisopos.expired_popup_mystery": "{type_label} erat, sed expletum est; itaque amisisti.",
    },
    "nl": {
        ...
        "hisopos.expired_caption_collected": "Het was een {type_label}, maar het is verlopen, dus je bent het misgelopen.",
        "hisopos.expired_caption_mystery": "Het was een {type_label}, maar het is verlopen, dus je bent het misgelopen.",
        "hisopos.expired_popup_collected": "Het was een {type_label}, maar het is verlopen, dus je bent het misgelopen.",
        "hisopos.expired_popup_mystery": "Het was een {type_label}, maar het is verlopen, dus je bent het misgelopen.",
    },
    "pt_BR": {
        ...
        "hisopos.expired_caption_collected": "Era um {type_label}, mas venceu, então você o perdeu.",
        "hisopos.expired_caption_mystery": "Era um {type_label}, mas venceu, então você o perdeu.",
        "hisopos.expired_popup_collected": "Era um {type_label}, mas venceu, então você o perdeu.",
        "hisopos.expired_popup_mystery": "Era um {type_label}, mas venceu, então você o perdeu.",
    },
    "pt_PT": {
        "hisopos.type.frenetic": "cotonete frenético",
        "hisopos.type.black_hole": "cotonete buraco negro",
        ...
        "hisopos.expired_caption_collected": "Era um {type_label}, mas expirou, por isso perdeste-o.",
        "hisopos.expired_caption_mystery": "Era um {type_label}, mas expirou, por isso perdeste-o.",
        "hisopos.expired_popup_collected": "Era um {type_label}, mas expirou, por isso perdeste-o.",
        "hisopos.expired_popup_mystery": "Era um {type_label}, mas expirou, por isso perdeste-o.",
    },
    "quz": {
        ...
        "hisopos.expired_caption_collected": "{type_label} karqan, ichaqa pachan tukurqan; chaymi chinkachirqanki.",
        "hisopos.expired_caption_mystery": "{type_label} karqan, ichaqa pachan tukurqan; chaymi chinkachirqanki.",
        "hisopos.expired_popup_collected": "{type_label} karqan, ichaqa pachan tukurqan; chaymi chinkachirqanki.",
        "hisopos.expired_popup_mystery": "{type_label} karqan, ichaqa pachan tukurqan; chaymi chinkachirqanki.",
    },
    "ru": {
        ...
        "hisopos.expired_caption_collected": "Это была {type_label}, но она просрочилась, поэтому вы её упустили.",
        "hisopos.expired_caption_mystery": "Это была {type_label}, но она просрочилась, поэтому вы её упустили.",
        "hisopos.expired_popup_collected": "Это была {type_label}, но она просрочилась, поэтому вы её упустили.",
        "hisopos.expired_popup_mystery": "Это была {type_label}, но она просрочилась, поэтому вы её упустили.",
    },
    "zh_Hans": {
        ...
        "hisopos.expired_caption_collected": "原来是{type_label}，但它过期了，所以你错过了。",
        "hisopos.expired_caption_mystery": "原来是{type_label}，但它过期了，所以你错过了。",
        "hisopos.expired_popup_collected": "原来是{type_label}，但它过期了，所以你错过了。",
        "hisopos.expired_popup_mystery": "原来是{type_label}，但它过期了，所以你错过了。",
    },
    "zh_Hant": {
        ...
        "hisopos.expired_caption_collected": "原來是{type_label}，但它過期了，所以你錯過了。",
        "hisopos.expired_caption_mystery": "原來是{type_label}，但它過期了，所以你錯過了。",
        "hisopos.expired_popup_collected": "原來是{type_label}，但它過期了，所以你錯過了。",
        "hisopos.expired_popup_mystery": "原來是{type_label}，但它過期了，所以你錯過了。",
    },
}
