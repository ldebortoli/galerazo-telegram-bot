...
- El 2026-07-29 se configuro localmente el token del bot real `@galerazo_bot`; se agrego el enlace de Cafecito a su descripcion larga (93/512) y corta (115/120), y se resincronizaron sus comandos sugeridos de BotFather. La descripcion corta usa Unicode correcto para `Configurá`, conserva `/config`, `Anuncios` y `Donaciones`. No se inicio el bot local ni se desplego produccion.
