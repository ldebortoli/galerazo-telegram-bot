...
- `/reiniciarbot` es exclusivo DEV: crea un tablero privado de cinco minutos. El solicitante puede confirmar o cancelar; clicks ajenos reciben popup. La expiracion se limpia bajo demanda y el reinicio reejecuta el proceso despues de drenar las updates pendientes.
