...
- `/reiniciarbot` es exclusivo DEV: crea un tablero privado de cinco minutos. El solicitante puede confirmar o cancelar; clicks ajenos reciben popup. La expiracion se limpia bajo demanda; al confirmar, detiene polling, drena las updates ya aceptadas y reejecuta el proceso. Las updates posteriores se recuperan al inicio porque el polling no descarta pendientes.
