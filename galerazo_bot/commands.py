...
def handle_command(
    ...
    send_galerazas=None,
    send_hisopos=None,
    send_hisopo_collection=None,
    send_donation_menu=None,
    ...
    return asyncio.run(
        handle_command_async(
            ...
            send_hisopos=send_hisopos,
            send_hisopo_collection=send_hisopo_collection,
            send_donation_menu=send_donation_menu,
